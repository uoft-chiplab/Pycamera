...
# The camera object
from experiment import Camera as PixisCamera
...
#        camera.get_buffer_size()
        ...
        # 8 sub-images 
        # NEW: two OD images
        # OD1 ~ image5/image7, OD2 ~ image6/image8
            ...
            data['O.D.1'] = make_OD(data['image5'],580,data['image7'],580)
            data['O.D.2'] = make_OD(data['image6'],580,data['image8'],580)
            # define 'image_data_to_save' for disk-space-saving.
            # Save 'signal', 'reference', and 'dark' images.
            image_data_to_save = {'image5':data['image5'],\
              'image6':data['image6'], 'image7':data['image7'],\
              'image8':data['image8']}
        #
        # 10 sub-images 
